...
# Force reload .env to get GROQ key
from dotenv import load_dotenv
load_dotenv(override=True)

print("Testing RAG System (Groq + Local Embeddings)...")
...
print("\nStep 3: Initializing vector store (loading local model)...")
try:
...
try:
    # Clear existing first to avoid dimension mismatch if switching models
